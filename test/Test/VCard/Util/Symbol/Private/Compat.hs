...
module Test.VCard.Util.Symbol.Private.Compat (tests) where
...
test_sConsSymbol =
  testCase "sConsSymbol" $ do
    assertEqualSSymbol
      (sConsSymbol (charSing @'a') (symbolSing @""))
      (symbolSing @"a")

    assertEqualSSymbol
      (sConsSymbol (charSing @'a') (symbolSing @"b"))
      (symbolSing @"ab")

    assertEqualSSymbol
      (sConsSymbol (charSing @'a') (symbolSing @"bc"))
      (symbolSing @"abc")
