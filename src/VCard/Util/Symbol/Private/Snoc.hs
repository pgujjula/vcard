...
module VCard.Util.Symbol.Private.Snoc
  ( SnocSymbol,
    sSnocSymbol,
    UnsnocSymbol,
    sUnsnocSymbol,
...
import VCard.Util.Symbol.Private.Append (sAppendSymbol)
...
import VCard.Util.Symbol.Private.Singleton (SingletonSymbol, sSingletonSymbol)
