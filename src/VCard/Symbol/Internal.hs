...
-- | Singleton version of 'ToLowerUncons'.
...
-- | Singleton version of 'ToLowerChar'.
...
-- | Singleton version of 'ToUpperUncons'.
...
-- | Singleton version of 'ToUpperChar'.
